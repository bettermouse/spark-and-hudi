...
//    conf.addResource("hbase-site.xml");
    conf.set("dfs.nameservices", "XX8003258");
    conf.set("dfs.ha.namenodes.XX8003258", "nn1,nn2");
    conf.set("dfs.namenode.rpc-address.XX8003258.nn1", "10.0.6.17:4007");
    conf.set("dfs.namenode.rpc-address.XX8003258.nn2", "10.0.6.3:4007");
    conf.set("dfs.client.failover.proxy.provider.XX8003258", "org.apache.hadoop.XX.server.namenode.ha.ConfiguredFailoverProxyProvider");
    conf.set("hbase.rootdir", "XX://XX8003258/hbase")
    val scan = new Scan();
...
//    scan.setCacheBlocks(false); //必须设置为false
    ...
    TableSnapshotInputFormatImpl.setInput(conf, snapshotName, new Path("XX://XX8003258/tmp"));
