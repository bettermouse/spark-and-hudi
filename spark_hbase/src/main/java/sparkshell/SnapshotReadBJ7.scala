...
//    conf.addResource("hbase-site.xml");
    conf.set("dfs.nameservices", "XX8003257");
    conf.set("dfs.ha.namenodes.XX8003257", "nn1,nn2");
    conf.set("dfs.namenode.rpc-address.XX8003257.nn1", "10.0.7.10:4007");
    conf.set("dfs.namenode.rpc-address.XX8003257.nn2", "10.0.7.43:4007");
    conf.set("dfs.client.failover.proxy.provider.XX8003257", "org.apache.hadoop.XX.server.namenode.ha.ConfiguredFailoverProxyProvider");
    conf.set("hbase.rootdir", "XX://XX8003257/hbase")
    val scan = new Scan();
...
//    scan.setCacheBlocks(false); //必须设置为false
    ...
    TableSnapshotInputFormatImpl.setInput(conf, snapshotName, new Path("XX://XX8003257/tmp"));
