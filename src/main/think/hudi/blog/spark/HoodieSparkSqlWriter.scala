...
object HoodieSparkSqlWriter {
  ...
  (Boolean, HOption[String], HOption[String], HOption[String], SparkRDDWriteClient[_], HoodieTableConfig) = {
    ...
    if (mode == SaveMode.Ignore && tableExists) {
      ...
      // NOTE: We need to make sure that upon conversion of the     val latestTableSchemaFromCommitMetadata =
      //      toScalaOption(tableSchemaResolver.getTableAvroSchemaFromLatestCommit(false))s b/w Catalyst's [[StructType]] and
