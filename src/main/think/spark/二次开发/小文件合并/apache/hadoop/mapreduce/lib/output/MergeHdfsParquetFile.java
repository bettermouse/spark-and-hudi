...
public class MergeXXParquetFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        mergeParquet("file:///Z:\\tmp\\spark\\x=0");
    }


    public static void mergeParquet(String dir) throws Exception {
        //查看schema 是否一致
...
//            }
    ...
    private static Configuration getConfiguration(){
        ...
        //path中就不用加XX://127.0.0.1:9000了
      //  configuration.set(FileSystem.FS_DEFAULT_NAME_KEY, "XX://127.0.0.1:9000");
    ...
    public static void setFileSystem(FileSystem fileSystem) {
        MergeXXParquetFile.fileSystem = fileSystem;
    }
}
